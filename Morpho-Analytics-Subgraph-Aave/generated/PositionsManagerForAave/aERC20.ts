...
export class aERC20__getScaledUserBalanceAndSupplyResult {
  value0: BigInt;
  value1: BigInt;
...
export class aERC20 extends ethereum.SmartContract {
  static bind(address: Address): aERC20 {
    return new aERC20("aERC20", address);
  }
  ...
  getScaledUserBalanceAndSupply(
    user: Address
  ): aERC20__getScaledUserBalanceAndSupplyResult {
    let result = super.call(
      "getScaledUserBalanceAndSupply",
    ...
    return new aERC20__getScaledUserBalanceAndSupplyResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getScaledUserBalanceAndSupply(
    user: Address
  ): ethereum.CallResult<aERC20__getScaledUserBalanceAndSupplyResult> {
    let result = super.tryCall(
      "getScaledUserBalanceAndSupply",
      "getScaledUserBalanceAndSupply(address):(uint256,uint256)",
      [ethereum.Value.fromAddress(user)]
    ...
    return ethereum.CallResult.fromValue(
      new aERC20__getScaledUserBalanceAndSupplyResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
