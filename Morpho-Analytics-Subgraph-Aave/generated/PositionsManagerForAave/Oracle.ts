...
export class WethSet extends ethereum.Event {
  get params(): WethSet__Params {
    return new WethSet__Params(this);
  }
}

export class WethSet__Params {
  _event: WethSet;

  constructor(event: WethSet) {
    this._event = event;
  }
